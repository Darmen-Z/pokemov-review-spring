...
public class ReviewController {
    ...
    public ResponseEntity<ReviewDto> getReviewDto(@PathVariable(value = "pokemonId")int pokemonId, @PathVariable(value = "id")int reviewId){
        ReviewDto reviewDto =  reviewService.getReviewById(reviewId , pokemonId);
        return new ResponseEntity<>(reviewDto, HttpStatus.OK);
    }

    @PutMapping("/pokemon/{pokemonId}/reviews/{id}")
    public ResponseEntity<ReviewDto> updateReviewDto(@PathVariable(value = "pokemonId")int pokemonId, @PathVariable(value = "id")int reviewId,
